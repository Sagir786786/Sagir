...
const token = '6799972639:AAGaBMUDsAg9c_pwk31ZNrF7rrEKvd_hTFE';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${bgmi}`);
  console.log(`• Username: ${Bgmisagirbot || 'Tidak ada'}`);
  console.log(`• Chat ID: ${@Bgmisagirbot}`);
  console.log(`• Perintah: ${start}`);
}
